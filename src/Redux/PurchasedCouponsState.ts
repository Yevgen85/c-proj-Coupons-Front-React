...
//4
export function getPurchasedFetchAction(
  purchasedCouponList: CouponModel[]
): PurchasedCouponAction {
  return {
    type: PurchasedCouponActionType.FetchCoupons,
    payload: purchasedCouponList,
  };
}
...
//5
export function purchasedCouponsReducer(
  currentState: PurchasedCouponsState = new PurchasedCouponsState(),
  action: PurchasedCouponAction
): PurchasedCouponsState {
